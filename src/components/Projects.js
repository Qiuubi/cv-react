...
function Projects(props) {
    ...
    const proTitle = "Projets professionnels";
    const persoTitle = "Projets personnels";

    return (
        <section className="cv-quang-projects">
            <Project projects={proProjects} title={proTitle} />
            <Project projects={persoProjects} title={persoTitle} />
        </section >
    )
}
